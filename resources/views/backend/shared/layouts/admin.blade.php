                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 p-0 footer-left">
                            <p class="mb-0">Copyright © {{date('Y')}} {{env('COMPANY_NAME')}}. All rights reserved. </p>
                        </div>
                        <div class="col-md-6 p-0 footer-right">
                            <p class="mb-0">Design & Developed By Md. Mutasim Naib <i class="fa fa-heart font-danger"></i></p>
                        </div>
                    </div>
                </div>
            </footer>
