...
@section('content')
    ...
    <div class="modal fade" id="add-subcategory-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-hidden="true">
                    ...
                    <form method="POST" action="" id="add_sub_category_form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-2">
                                ...
                                <input type="file" class="form-control" name="sub_category_image" id="sub_category_image" accept="image/png, image/gif, image/jpeg">
                                <span class="text-danger err-mgs"></span>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if (hasPermission(['course-subcategory-store']))
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    @foreach ($sub_categories as $sub_category)
                                        <tr id="trid-{{ $sub_category->id }}" data-id="{{ $sub_category->id }}">
                                            ...
                                            <td class="text-center">
                                                @if (hasPermission(['course-subcategory-update']))
                                                    <span
                                            ...
                                            <td>
                                                @if (hasPermission(['course-subcategory-update', 'course-subcategory-delete']))
                                                    <div class="dropdown">
                                                        <button
                                                        ...
                                                        <div class="dropdown-content">
                                                            ...
                                                            @endif
                                                            @if (hasPermission(['course-subcategory-delete']))
...
@push('js')
    ...
    <script>
        ...
        $('.js-example-basic-single').select2({
            dropdownParent: $('#add-subcategory-modal')
        });
        ...
        var form_url = "{{ route('admin.course.subCategory.store') }}";
        var base_url = "{{ URL::to('/') }}";
