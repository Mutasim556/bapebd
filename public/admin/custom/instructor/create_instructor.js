...
$('#add_instructor_form').submit(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function (datam) {
            ...
            $('button[type=submit]', '#add_instructor_form').html('Submit');
            $('button[type=submit]', '#add_instructor_form').removeClass('disabled');
            swal({
                icon: "success",
                title: datam.title,
                text: datam.text,
                ...
                $('#add_instructor_form').trigger('reset');
                $('button[type=button]', '#add_instructor_form').click();
